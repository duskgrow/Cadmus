...
## [Unreleased]
## [0.1.0](https://github.com/duskgrow/Cadmus/releases/tag/v0.1.0) - 2026-09-24
### Agent
- resolve approvals per call and preview blocked results
### Cadmus
...
### Cli
- default --max-tokens to the model's registry value
### Contract
- carry the approval wait budget on the request
...
### Other
- dedupe run wiring and band-render plumbing
- initialize from template
### Rules
- drop the turn grant scope
- the client-side approval rule engine
### Tools
...
### Tui
- land the item-7 settings loader and the motion key ([#20](https://github.com/duskgrow/Cadmus/pull/20))
- rework the band around paced emission and a run-status row
- land the interactive approval dialog
- build the shell before the input broker exists
- land the app event loop and the interactive chat

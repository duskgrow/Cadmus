...
| -------------------------------------- | ----------------------------------------------------------------------- | ----------- | -------------------------------------------------------------------------------------------------------------------------- |
| 0. Minimal agent loop                  | chat + coding tools + two providers validating the dialect seam         | in progress | [0002](decisions/0002-hexagonal-architecture-event-sourced-core.md), [0003](decisions/0003-provider-abstraction-layers.md) |
